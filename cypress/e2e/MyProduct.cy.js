...
// Filter
    ...
    //         .find('.ant-select-item-option').contains('CompanySteven').click();
            // class="ant-select-item  ant-select-item-option-active"
      // cy.wait(2000);
...
//       // Click reset filter
//       cy.get('.ant-btn').contains('Reset Filter').click();
...
//       cy.get('#filter_product_filterName').click({force: true}).type('Filter 01');
